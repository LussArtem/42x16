 ...
 */
    ...
    (() => {
        ...
        if (isMobile) modules_flsModules.mousePrlx = new MousePRLX({});
        ...
        function initSliders() {
            if (document.querySelector(".types__body")) new swiper_core_Swiper(".types__body", {
            ...
            if (document.querySelector(".works__body")) new swiper_core_Swiper(".works__body", {
            ...
            if (document.querySelector(".partners__body")) new swiper_core_Swiper(".partners__body", {
                modules: [ Scrollbar, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 2.3,
            ...
            if (document.querySelector(".sliders-cart")) {
                let subslider = new swiper_core_Swiper(".subslider-cart", {
                    modules: [ Thumb ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 4,
                ...
                new swiper_core_Swiper(".sliders-cart__main", {
                    modules: [ Thumb ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
